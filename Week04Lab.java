...
public class Week04Lab {
	...
	public static void main(String[] args) {
		...
		//Stringbuilders are dynamic and can be changed while strings need to be updated and take up more memory.
...
strings.add("Amanda");
strings.add("Paul");
strings.add("Johannah");
// Can also do:
// List<String> strings = Arrays.asList("Tom", "Cindy", "Amanda", "Paul", "Johannah")
...
List<String> swapped = reverseElements(strings);
...
List<String> concatenated = concatenatedList(strings);
for (String string : concatenated) {
...
List<String> searchResults = search(strings, "an");
...
List<Integer> numbers = Arrays.asList(1, 2, 3, 4, 5, 6, 7, 8 , 9, 25, 35, 46, 62);
...
Set<String> startsWithH = findAllThatStartWith(set, 'L');
...
integerSet.add(8);
integerSet.add(33);
Set<Integer> extractedEvens = evenNumbers(integerSet);
...
dictionary.put("Apple", "A crunch fruit. Usually red, green, or yellow.");
...
System.out.println(value);
			...
			for (Character character : counts.keySet()) {
				System.out.println(character + " - " + counts.get(counts));
			}
	...
	public static List<String> search(List<String> list, String query) {
		...
		for (String string : list) {
			...
			// Method 5:
	public static List<String> concatenatedList(List<String> words) {
		return words;
	}
